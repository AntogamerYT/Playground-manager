module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if(interaction.customId != 'hehim') return
        ...
        if(!interaction.member.roles.cache.has('899302127426469928')) await interaction.member.roles.add('899302127426469928')
        return interaction.reply({content: 'You pronouns have been set to **He/Him**.', ephemeral: true})
    }
}